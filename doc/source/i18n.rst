...
By default, internationalization is used by :class:`Converters' <insanities.forms.convs.Converter>` error method. This method accepts name of the error, looks up it's message in converters' error_%(name)s attribute and translates the message.
