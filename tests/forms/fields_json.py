...
from iktomi.forms.form_json import Form, FieldSet, FieldList, FieldBlock, Field, \
            FileField
...
class FieldTests(unittest.TestCase):
    ...
    def test_accept(self):
        ...
        form = _Form(env)
        self.assert_(form.accept(dict(input='value')))
    ...
    def test_from_python_multiple(self):
        ...
        env = AppEnvironment.create()
        form = F(env)
        self.assertEqual(form.get_data(),{'name': ['1', '2'] })
...
class FieldBlockTests(unittest.TestCase):
    ...
    def test_initial(self):
        ...
        self.assertEqual(form.get_data(), {'number': '3'})
    ...
    def test_accept(self):
        ...
        env = AppEnvironment.create()
        form = _Form(env)
        self.assertEqual(form.get_data(), dict([('number', '')]))
    ...
    def test_fieldblock_in_fieldset(self):
        ...
        self.assertEqual(form.get_data(), {'fs':{'number': '5'}})
    ...
    def test_nested(self):
        ...
        env = AppEnvironment.create()
        form = _Form(env)
        self.assertEqual(form.get_data(), {'number': '', 'title': ''})
        self.assertEqual(form.python_data, {'number': None, 'title': None})
